        ...
        function() {
            $(".menuIcon").toggleClass("js-menuOpen"),
                ...
                $(this).hasClass("js-menuOpen") ? (console.log("curation"),
                    ...
                    Barba.Pjax.getTransition = function() { return PageTransitionTop }) : (console.log("under"),
            ...
            $(".js-contact").on("click",
                function() {
                    $(".menuIcon").removeClass("js-menuOpen"),
                        ...
                        $.fn.fullpage.moveTo("contact"), Barba.Pjax.getTransition = function() { return PageTransitionTop }
                })
    },
...
$(function() {
    ...
    // Reexecute o script da API do YouTube ao iniciar uma nova transição de página
